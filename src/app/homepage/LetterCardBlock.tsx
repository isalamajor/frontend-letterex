  ...
  return (
    <div className="flex-1 w-full rounded-lg bg-gray-100 dark:bg-neutral-800 px-8 ">
      ...
      {settings.isLoading ? (
        ...
        <div className="max-h-[2.6rem] flex gap-2 flex-col lg:flex-row justify-between items-center text-gray-800 dark:text-gray-200">
          ...
          <div className="flex justify-center sm:justify-end items-center gap-2">
            <AnimatePresence mode="wait" initial={false}>
              {settings.deleteMode ? (
                ...
                >
                  <button
                    className="cursor-pointer border border-lightblack dark:border-neutral-700 dark:text-gray-200 rounded-sm bg-gray-150 dark:bg-neutral-800 shadow-md py-2 px-4 hover:bg-gray-50 dark:hover:bg-neutral-700"
                    onClick={() =>
                      setSettings({
                        ...settings,
                ...
                >
                  ...
                  <NewLetterButton />
                  <button
                    className="cursor-pointer border border-lightblack dark:border-neutral-700 dark:text-gray-200 rounded-sm bg-gray-150 dark:bg-neutral-800 shadow-md p-2 hover:bg-gray-50 dark:hover:bg-neutral-700"
                    onClick={() =>
                      setSettings({ ...settings, deleteMode: true })
                    }
                  >
                    <Trash2 />
                  </button>
...
const NewLetterButton = () => {
  return (
    <Link href="/new-letter">
      <button className="cursor-pointer text-gray-800 dark:text-gray-200 dark:text-gray border border-lightblack dark:border-neutral-700 rounded-sm bg-gray-150 dark:bg-neutral-800 shadow-md py-2 px-4 hover:bg-gray-50 dark:hover:bg-neutral-700">
        💌 New
      </button>
    </Link>
  );
