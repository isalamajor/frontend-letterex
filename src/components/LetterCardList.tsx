...
const LetterCardList = ({
  ...
  if (diaryOrganised && filteredLetters && filteredLetters.length > 0) {
    return (
      <div className="flex flex-row gap-5 h-full sm:custom-scroll">
        {/* Diaries */}
        ...
        {/* Letters */}
        {!diarySelected ? (
          <div className="text-gray-500 bg-white rounded-lg shadow-md flex flex-col gap-y-3 items-center justify-center align-middle p-5 text-center h-[15rem]">
